...
import { JSX, Component, type VoidComponent } from 'solid-js';
                ...
                >
                  <h2 id={`accordion-collapse-heading-${i()}`}>
                    ...
                    >
                      ...
                      <svg
                        class={`size-2 shrink-0 ${activeID[i()] ? 'rotate-180' : ''} transition-transform duration-500`}
                        aria-hidden='true'
